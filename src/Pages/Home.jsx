...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/CharanChandu-11" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/p-charanchandu-74951030b/" },
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden p-5" id="Home">
